...
const groups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/egm-voting", title: "EGM voting record", description: "Register attendees, record ballots and produce the formal handicap decision.", mark: "EG", leagueOfficerOnly: true },
    ],
  },
  {
    title: "Competitions",
