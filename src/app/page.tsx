...
const links = [
  ...
  { href: "/display/handicaps", title: "Handicaps", desc: "See the snooker handicap list and how starts are worked out." },
  { href: "/display/high-breaks", title: "High Breaks", desc: "View the published league high-break table." },
